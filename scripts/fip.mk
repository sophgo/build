...
fsbl%: export CPU_OD_CLK_BIG=${CONFIG_CPU_OD_CLK_BIG}
fsbl%: export CPU_OD_CLK_1000M=${CONFIG_CPU_OD_CLK_1000M}
fsbl%: export CPU_OD_CLK_LITTLE=${CONFIG_CPU_OD_CLK_LITTLE}
fsbl%: export TPU_OD_CLK_SEL=${CONFIG_TPU_OD_CLK_SEL}
fsbl%: export SWITCH_32K_XTAL=$(CONFIG_SWITCH_32K_XTAL)
