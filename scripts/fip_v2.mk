...
ifeq ($(call qstrip,${CONFIG_ARCH}),arm64)
fsbl-build: export RTC_CORE_SRAM_BIN_PATH=${FSBL_PATH}/test/blds.bin
endif
...
fsbl-build: u-boot-build memory-map
	...
	${Q}$(MAKE) -j${NPROC} -C ${FSBL_PATH} ${SPD_MAKE_OPT} O=${FSBL_OUTPUT_PATH} BLCP_2ND_PATH=${BLCP_2ND_PATH} \
