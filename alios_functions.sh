...
function _build_alios_env()
{
	...
	export FLASH_CONFIG_YAML=${ALIOS_PATH}/boards/cv182x_evb/configs/config.yaml
	export PATH=${ALIOS_PATH}/host-tools/gcc-arm-10.3-2021.07-x86_64-aarch64-none-elf/bin:${PATH}
