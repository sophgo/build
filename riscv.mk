...
ifdef CONFIG_C906_HART1
	${Q}cp ${OPENSBI_PATH}/build/platform/generic/firmware/fw_payload.bin ${OUTPUT_DIR}/sophon_firmware0_os.bin
	${Q}cp ${OPENSBI_PATH}/build/platform/generic/firmware/fw_payload.bin ${LIBSOPHON_PATH}/driver/sophon_firmware0_os.bin
else ifdef CONFIG_C906_HART2
	${Q}cp ${OPENSBI_PATH}/build/platform/generic/firmware/fw_payload.bin ${OUTPUT_DIR}/sophon_firmware1_os.bin
	${Q}cp ${OPENSBI_PATH}/build/platform/generic/firmware/fw_payload.bin ${LIBSOPHON_PATH}/driver/sophon_firmware1_os.bin
endif