...
alios-depends:
	...
	${Q}ln -snf $(TOP_DIR)/build/media/PanelSupportList $(TOP_DIR)/cvi_alios/components/cvi_mmf_sdk/
...
#	${Q}rm -f $(TOP_DIR)/cvi_alios/components/cvi_mmf_sdk/PanelSupportList
