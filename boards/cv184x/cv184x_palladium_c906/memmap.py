...
class MemoryMap:
    ...
    # =============================
    RTOS_SYS_SIZE = 10 * SIZE_1M
    SIZE = 128 * SIZE_1K
    SHARE_MEM_SIZE = 128 * SIZE_1K
    SHARE_PARAM_SIZE = 64 * SIZE_1K
    PQBIN_SIZE = 1024 * SIZE_1K
    RTOS_ION_SIZE = FREERTOS_SIZE - SIZE - \
        RTOS_SYS_SIZE - SHARE_MEM_SIZE - \
        (SHARE_PARAM_SIZE * 2) - PQBIN_SIZE

    FSBL_C906L_START_ADDR = FREERTOS_ADDR
    RTOS_ION_ADDR = FSBL_C906L_START_ADDR + RTOS_SYS_SIZE
    ADDR = RTOS_ION_ADDR + RTOS_ION_SIZE
    SHARE_MEM_ADDR = ADDR + SIZE
    ...
    RTOS_COMPRESS_BIN_ADDR = FSBL_C906L_START_ADDR + 6 * SIZE_1M
    ...
    FREERTOS_RESERVED_ION_SIZE = H26X_BITSTREAM_SIZE + \
        H26X_ENC_BUFF_SIZE + ISP_MEM_BASE_SIZE + \
        BOOTLOGO_SIZE + SHARE_MEM_SIZE
    ...
    UIMAG_ADDR = DRAM_BASE + 16 * SIZE_1M
