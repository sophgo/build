...
class MemoryMap:
    ...
    ALIOS_RESV_SIZE = FREERTOS_SIZE - ALIOS_LOG_SIZE - ALIOS_SYS_SIZE - \
        SHARE_MEM_SIZE - (SHARE_PARAM_SIZE * 2) - PQBIN_SIZE
    ...
    FREERTOS_RESERVED_ION_SIZE = H26X_BITSTREAM_SIZE + H26X_ENC_BUFF_SIZE \
