...
cp $TOPDIR/u-boot-2021.10/build/sophon_palladium/u-boot.bin target/
cp $TOPDIR/ramdisk/build/sophon_palladium/workspace/Image target/
cp $TOPDIR/ramdisk/build/sophon_palladium/workspace/boot.cpio.gz.img target/
cp $TOPDIR/ramdisk/build/sophon_palladium/workspace/sophon_palladium.dtb target/
...
$TOPDIR/pld_tool/sophon_pld_sram_memtool_v1 0 $TOPDIR/pld_tool/target/bl2.bin $bl2_size bl2 0 ../c_build/ 1

bl31_size=`ls -l $TOPDIR/pld_tool/target/bl31.bin | awk '{print $5}'`
$TOPDIR/pld_tool/sophon_pld_ddr_mem_tool 0 $TOPDIR/pld_tool/target/bl31.bin $bl31_size bl31 0 ../c_build/ 1
...
$TOPDIR/pld_tool/sophon_pld_ddr_mem_tool 0 $TOPDIR/pld_tool/target/u-boot.bin $uboot_size uboot 0x40000 ../c_build/ 1
...
$TOPDIR/pld_tool/sophon_pld_ddr_mem_tool 0 $TOPDIR/pld_tool/target/Image $image_size image 0x4000000 ../c_build/ 1
cat $TOPDIR/pld_tool/target/backdoor/reload_ddr.tcl >> $TOPDIR/pld_tool/target/backdoor/workspace/reload_ddr_tmp.tcl
...
$TOPDIR/pld_tool/sophon_pld_ddr_mem_tool 0 $TOPDIR/pld_tool/target/boot.cpio.gz.img $ramdisk_size ramdisk 0x5000000 ../c_build/ 1
cat $TOPDIR/pld_tool/target/backdoor/reload_ddr.tcl >> $TOPDIR/pld_tool/target/backdoor/workspace/reload_ddr_tmp.tcl
echo "###ramdisk end###" >> $TOPDIR/pld_tool/target/backdoor/workspace/reload_ddr_tmp.tcl

dtb_size=`ls -l $TOPDIR/pld_tool/target/sophon_palladium.dtb | awk '{print $5}'`
$TOPDIR/pld_tool/sophon_pld_ddr_mem_tool 0 $TOPDIR/pld_tool/target/sophon_palladium.dtb $dtb_size dtb 0x6000000 ../c_build/ 1
cat $TOPDIR/pld_tool/target/backdoor/reload_ddr.tcl >> $TOPDIR/pld_tool/target/backdoor/workspace/reload_ddr_tmp.tcl
