...
/**
 * @brief Enable VI Patgen for test.
 *
 * @param ViDev(Out), Device ID.
 *
 * @return CVI_S32 Return CVI_SUCCESS if succeed.
 */
...
/**
 * @brief Set vi device extended attribute.
 *
 * @param ViDev(In), Device ID.
 * @param pstDevAttr(In), Device attribute.
 *
...
/**
 * @brief Get vi device extended attribute.
 *
 * @param ViDev(In), Device ID.
 * @param pstDevAttr(Out), Device Attribute
 *
...
/**
 * @brief Set vi device bind attribute.
 *
 * @param ViDev(In), Device ID.
 * @param pstDevBindAttr(In), Device bind attribute.
 *
 * @return CVI_S32 Return CVI_SUCCESS if succeed.
 */
...
/**
 * @brief Get vi device bind attribute.
 *
 * @param ViDev(In), Device ID.
