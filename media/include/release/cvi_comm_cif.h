...
enum ttl_src_e {
	TTL_VI_SRC_VI0 = 0,
	TTL_VI_SRC_VI1,		/* BT demux & BT*/
	TTL_VI_SRC_VI2,		/* BT demux & BT*/
	TTL_VI_SRC_NUM
};
...
#define CVI_MIPI_SET_HS_MODE		_IOW(CVI_MIPI_IOC_MAGIC, \
						0x0B, unsigned int)
#define CVI_MIPI_ENABLE_CVI_MIPI_CLOCK		_IOW(CVI_MIPI_IOC_MAGIC, \
						0x0C, unsigned int)
#define CVI_MIPI_DISABLE_CVI_MIPI_CLOCK		_IOW(CVI_MIPI_IOC_MAGIC, \
						0x0D, unsigned int)
...
#endif /* End of #ifndef_CVI_COMM_CIF_H__ */
