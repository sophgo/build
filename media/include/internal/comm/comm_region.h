...
#ifdef __arm__
	__u32 virtaddr_padding; /* padding for keeping same size of this structure */
#endif
	size_s size;
	unsigned int stride;
	pixel_format_e pixel_format;
...
#ifdef __arm__
	__u32 canvascmprattr_padding; /* padding for keeping same size of this structure */
#endif
	rgn_cmpr_obj_attr_s *pobj_attr;
#ifdef __arm__
	__u32 objattr_padding; /* padding for keeping same size of this structure */
#endif
} rgn_canvas_info_s;
