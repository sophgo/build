...
/* DWA define error code */
#define ERR_DWA_NOBUF DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define ERR_DWA_NOMEM DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define ERR_DWA_BUF_EMPTY DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define ERR_DWA_NULL_PTR DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define ERR_DWA_ILLEGAL_PARAM DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define ERR_DWA_BUF_FULL DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define ERR_DWA_SYS_NOTREADY DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define ERR_DWA_NOT_SUPPORT DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define ERR_DWA_NOT_PERMITTED DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define ERR_DWA_BUSY DEF_ERR(ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)

/* TDE define error code */
#define ERR_TDE_ILLEGAL_PARAM DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define ERR_TDE_UNEXIST DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
#define ERR_TDE_NULL_PTR DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define ERR_TDE_NOT_SUPPORT DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define ERR_TDE_NOT_PERM DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define ERR_TDE_NOMEM DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define ERR_TDE_BUF_EMPTY DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define ERR_TDE_BUF_FULL DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define ERR_TDE_NOTREADY DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define ERR_TDE_BUSY DEF_ERR(ID_TDE, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
